// Saivenkat Jilla
// May 30th, 2022
//Score1 class handles the game score for the player on the left
...
public class Score1 extends Rectangle{
  ...
  public void draw(Graphics g){
    ...
    g.drawString(String.valueOf(score), (int)(GAME_WIDTH*0.24), (int)(GAME_HEIGHT*0.2)); //setting location of score to be about the middle of player 1's side
  }
}
